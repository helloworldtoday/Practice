...
public class BasicCalculator implements ActionListener{
	...
	BasicCalculator() {
		...
		num0 = new Button("0"); num1 = new Button("1"); num2 = new Button("2");
		num3 = new Button("3"); num4 = new Button("4"); num5 = new Button("5");
		...
		bFrac = new Button("1/x"); bInt = new Button("+/-");
		bDot = new Button("."); bCE = new Button("CE");
		equals = new Button("="); backspace = new Button("Backspace");
		clear = new Button("C");
	}
	...
	public void actionPerformed(ActionEvent a){
		try {
			...
			if (a.getSource() == num0 || a.getSource() == num1 || 
					a.getSource() == num2 || a.getSource() == num3 ||
					a.getSource() == num4 || a.getSource() == num5 ||
					a.getSource() == num6 || a.getSource() == num7 ||
					a.getSource() == num8 || a.getSource() == num9) {
			...
			if (a.getSource() == bAdd || a.getSource() == bSub || 
					a.getSource() == bMul || a.getSource() == bDiv ||
					a.getSource() == bPer) {
				ctr = 0;
		...
		/* |-- EQUALS ACTION --| */
			...
			if (a.getSource() == equals) {
				...
				answer = basic.calculate(o, v1, v2);
		...
		/* |-- EQUALS ACTION --| */
			...
			if (a.getSource() == bFrac) {
				ctr = 0;
				value = "";
				String textGet = tField.getText();
				Double NumberContainer = (1 / Double.parseDouble(textGet));
...
/* |-------- Attempting To Catch Runtime Errors ---------| */
	...
	public void setPanel() {
		...
		p2.add(backspace); p2.add(bCE); p2.add(clear);

		p3.add(num7); p3.add(num8); p3.add(num9);
		p3.add(bDiv); p3.add(bSqrt);

		p4.add(num4); p4.add(num5); p4.add(num6);
		p4.add(bMul); p4.add(bPer);

		p5.add(num1); p5.add(num2); p5.add(num3);
		p5.add(bSub); p5.add(bFrac);

		p6.add(num0); p6.add(bInt); p6.add(bDot);
		p6.add(bAdd); p6.add(equals);
